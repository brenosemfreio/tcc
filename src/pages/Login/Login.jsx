...
/* SVG oficiais inline para OAuth (Google colorido + GitHub preto) */
function GoogleIcon() {
  return (
  ...
  return (
    <div className="login-page">
      ...
      <div className="login-right">
        <a className="login-voltar" onClick={() => navigate(-1)}>
          ← Voltar
        </a>

        <div className="login-card">
          <h1 className="login-card__title">Entrar na conta</h1>
          <p className="login-card__subtitle">Acesse seu painel e continue de onde parou.</p>

          {/* OAUTH */}
          <div className="login-oauth">
            <button className="login-oauth__btn">
              <GoogleIcon /> Google
            </button>
            <button className="login-oauth__btn">
              <GitHubIcon /> GitHub
          ...
          <div className="login-divider">
            ...
            <span className="login-divider__text">OU CONTINUE COM EMAIL</span>
            <div className="login-divider__line" />
          </div>
          ...
          <a href="/esqueci-senha" className="login-forgot">Esqueceu a senha?</a>
