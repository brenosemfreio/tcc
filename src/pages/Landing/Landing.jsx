...
const TESTIMONIALS = [
  {
    ...
    initials: 'AL',
    color: '#E84FA5',
    quote: 'Desde que comecei a usar o HubStudio, meu engajamento subiu 127%. A IA sugere os melhores horários e nunca deixo de postar.',
  },
  {
    name: 'Carlos Mendes',
    role: 'Fotógrafo & Influencer',
    initials: 'CM',
    color: '#4F35E8',
    quote: 'Gerenciar 5 plataformas ao mesmo tempo parecia impossível. Agora faço tudo em minutos e ainda tenho tempo pra criar mais.',
  },
  {
    name: 'Priya Santos',
    ...
    initials: 'PS',
    color: '#7C5FE8',
    quote: 'O analytics do HubStudio é incrível. Consigo mostrar resultados reais para os meus clientes com dados atualizados em tempo real.',
  },
]
